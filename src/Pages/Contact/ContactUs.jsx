...
function ContactUs() {
  ...
  const onSubmit = e => {
    ...
    setLoading(true);
    axios.post(import.meta.env.REACT_APP_BACKEND_API_ROUTE + '/contact-us', { name, email, subject, message, company }, config)
      .then(res => {
                  ...
                  <div className="row justify-content-center">
                    ...
                    <div className="col-md-24">
                      <div className={css["control__acceptterms"]}>
                        ...
                        <button className='contact__form__button' htmltype='submit'><img src={agreeImg} htmlFor="r_acceptterms" />
                        </button>
